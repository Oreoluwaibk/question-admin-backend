      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="mt-3 text-sm leading-6 text-muted sm:text-base">
            ...
            from the app under Profile → Legal → Delete account & data.
          </p>
        </div>
        ...
        <section className="space-y-3">
          ...
          <ol className="list-decimal space-y-2 pl-5 text-sm leading-6 text-muted">
            <li>Submit the form below with the email address tied to your account.</li>
            <li>
        ...
        <section className="rounded-2xl border border-border bg-card p-5 sm:p-6">
          ...
          <p className="mt-2 mb-5 text-sm text-muted">
            Signed in on the app? You can also request deletion from your profile
